    ...
    <Phone>
        ...
        <section className='overflow-y-scroll relative h-[515px] font-inter'>
            <div className='mx-4'>
                ...
                <p className='text-md font-medium text-black'>Product Designer</p>
            ...
            <div className='mx-4'>
                <p className='text-zinc-800 text-sm font-medium mb-2'>Job Summary</p>
            ...
            <div className='border-4 border-zinc-100 my-4'></div>
            <div className='mx-4'>
                <p className='text-zinc-800 text-sm font-medium mb-2'>Job Descriptions</p>
            ...
            <div className='border-4 border-zinc-100 my-4'></div>
            <div className='mx-4'>
                <p className='text-zinc-800 text-sm font-medium mb-2'>Requirements</p>
                <ul class="list-disc list-outside">
            ...
            <div className='border-4 border-zinc-100 my-4'></div>
            <div className='mx-4'>
                <p className='text-zinc-800 text-sm font-medium mb-2'>Required skills</p>
        ...
        <div className='bg-white w-[296px] mx-4 pt-4 pb-3 rounded-full'>
                <button className="btn w-full rounded-full text-white font-medium">Apply</button>
            </div>
        </section>
