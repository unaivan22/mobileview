        ...
        <Tab.List className='flex pb-3 bg-white w-safearea justify-between px-2'>
            ...
            <Tab as={Fragment}>
              {({ selected }) => (
                <button
                  className={
                    selected ? 'text-center flex flex-col items-center text-xs font-semibold px-4 py-2 text-rose-500 rounded-xl bg-white' : 'text-center flex flex-col items-center text-xs font-normal px-4 py-2 text-zinc-400 rounded-xl bg-white'
                  }
                >
